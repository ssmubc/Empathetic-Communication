...
```
cdk deploy --all --parameters VirtualCareInteractionAmplifyStack:githubRepoName=VIRTUAL-CARE-INTERACTION --context StackPrefix=VirtualCareInteraction --context prefix=VIRTUAL-CARE-INTERACTION-production --profile <your-profile-name>
