...
```
cdk deploy --all --parameters AmplifyStack:githubRepoName=VIRTUAL-CARE-INTERACTION --context prefix=VIRTUAL-CARE-INTERACTION-production --profile <your-profile-name> 
```
